//Clase que implementa una expresio de llamada a subprograma
...
public class ExpresionLLamadaSubprograma extends Exp{

	public ExpresionLLamadaSubprograma(TypeIF tipoExp) {
		super(tipoExp);
	}
	...
	public void generateIntermediateCode(String nombreSubprograma,LLamada_subprograma sub) {
		...
		//buscamos en el la tabla de simbolos del ambito de llamada (current scope) o del ambito padre (parent scope)
		// el simbolo del subprograma
		SymbolTableIF tablaSimbolosCurrentScope = parentScope.getSymbolTable();
