//Clase que implementa una expresion de acceso a registro
...
public class ExpresionAccesoRegistro extends Exp{

	public ExpresionAccesoRegistro(TypeIF tipo) {
		super(tipo);
	}
	...
	public void generateIntermediateCode(SymbolIF identificador,String nombreRegistro, int desplazamiento) {
		...
		iCodeB.addQuadruple("MVP",temp,dirCampo);
