//Clase que implementa la expresion de acceso a registro con campo puntero
...
public class ExpresionAccesoRegistroPuntero extends Exp{

	public ExpresionAccesoRegistroPuntero(TypeIF tipo) {
		super(tipo);
	}
	...
	public void generateIntermediateCode(SymbolIF identificador,String nombreRegistro, int desplazamiento) {
		...
		iCodeB.addQuadruple("MVP",temp2,dirCampo);
		iCodeB.addQuadruple("MVP",temp,temp2);
