//Clase que implementa una expresion MAYOR QUE
...
public class ExpresionMayorQue extends Exp{

	public ExpresionMayorQue(TypeIF tipo) {
		super(tipo);
	}
	
	public boolean tiposCompatibles(TypeIF tipo1, TypeIF tipo2) {
		//indica si 2 tipos de datos son compatibles en una expresion MAYOR QUE
		boolean res = false;
	...
	public void generateIntermediateCode(Exp exp1, Exp exp2) {
		...
		iCodeB.addQuadruple("MQ",temp,temp1,temp2);
